...
public class HomeFragment extends Fragment {
    ...
    private RecyclerView vegetableRecycle; //way to show all of the plants
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        initElement(v);
        initUser(userId); // show to data according to the user
        getAllPlants(v);

        iconList.setOnClickListener(view -> { //button for navigation
            ...
            popupMenu.setOnMenuItemClickListener(menuItem -> {
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.profile_popup_regis:
                        ...
                        return true;
                    case R.id.profile_popup_approval:
                        replaceFragment(new PlantsListRequestFragment());
                        return true;
