...
//            treatment.setChecked(false);
        ...
        treatment.setOnClickListener(view -> { //if plant type = fruit or veg, treatment is unchecked
            try {
                ...
                if (treatment.isChecked()) { //if treatment is selected = herb
...
//            bulb.setChecked(false);
    ...
    private void botanicalListener() { // initial set to set the check all false
    ...
    private void otherEvent() {
        family.setOnClickListener(view -> { //if family checked then retrieve the family data
            if (family.isChecked()) {
        ...
        season.setOnClickListener(view -> { //season
            if (season.isChecked()) {
        ...
        nutrient.setOnClickListener(view -> { //if the nutrient is checked, show the mineral and vitamin
        ...
        planting.setOnClickListener(view -> { //planting
        ...
        plantCare.setOnClickListener(view -> {
            if (plantCare.isChecked()) { // if plant care is checked then retrieve test inf
    ...
    private void initParameterAntSwitchFragment() {
        FragmentManager fragmentManager = getActivity().getSupportFragmentManager(); //create fragment
    ...
    private void initCheckBox() { //checkbox initial according to what plant
