...
public class OntologyFilteredFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        initElement(v); //layout this fragment and declare values
    ...
    private void initfield(View v) { //create array
        System.out.println("size 1 = " + plantsList.size());
        if (!ontologySearch.getBotanicalHabit().equalsIgnoreCase("") && plantsFiltered.size() > 0) { //botanical habit
        ...
        if (!ontologySearch.getFamily().equalsIgnoreCase("") && plantsFiltered.size() > 0) { //family
        ...
        if (!ontologySearch.getSeason().equalsIgnoreCase("") && plantsFiltered.size() > 0) { //season
